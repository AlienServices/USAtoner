...
export default function LexmarkPage() {
  ...
  useEffect(() => {
    if (typeof window !== 'undefined' && localStorage.getItem("lexmark")) {
      try {
        const storedProducts = JSON.parse(localStorage.getItem("lexmark"));
            ...
            <div className={styles.mainContainer}>
              ...
              <h1>
                <div className={styles.homepageTitle}>
                  Lexmark Printer Models & Supplies
                </div>
              </h1>
              <input 
                  ...
                  {selectedModel && (
                    <div className={styles.modelProductsHeader}>
                      <h1 className={styles.modelProductsTitle}>
                        Supplies for Lexmark {selectedModel}
                      </h1>
                      <button 
                    ...
                    {filteredProducts?.length > 0 ? (
                      ...
                      <div className={styles.emptyProductsContainer}>
                        <div className={styles.nothing}>
                          {selectedModel 
                            ? `No supplies found for Lexmark ${selectedModel}`
