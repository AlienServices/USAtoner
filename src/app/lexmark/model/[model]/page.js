...
const ModelSupplies = () => {
    ...
    async function getModelSupplies() {
        try {
            ...
            const partToModelMap = {
                '24B6511': ['XC6152', 'XC6153', 'XC8155'],
                '24B6510': ['XC6152', 'XC6153', 'XC8155'],
                '24B6508': ['XC6152', 'XC6153', 'XC8155'],
                '24B6509': ['XC6152', 'XC6153', 'XC8155'],
                '24B6515': ['XC8160', 'XC8163'],
                '24B6514': ['XC8160', 'XC8163'],
                '24B6512': ['XC8160', 'XC8163'],
                '24B6513': ['XC8160', 'XC8163'],
                '24B7157': ['C2240', 'XC2235'],
                '24B7156': ['C2240', 'XC2235'],
                '24B7154': ['C2240', 'XC2235'],
                '24B7155': ['C2240', 'XC2235'],
            ...
            for (const searchVariant of [`lexmark ${modelNumber}`, `lexmark xc${modelNumber}`, `lexmark cs${modelNumber}`]) {
                ...
                try {
                    ...
                    if (data?.cancel?.products && Array.isArray(data.cancel.products)) {
                        ...
                        if (validProducts.length > 0) {
                            ...
                            localStorage.setItem(`lexmark_model_${modelNumber}`, JSON.stringify(validProducts));
                            setIsLoading(false);
                            return;
                        }
                    }
            ...
            try {
                const modelCache = localStorage.getItem(`lexmark_model_${modelNumber}`);
                if (modelCache) {
            ...
            for (const [partNumber, compatibleModels] of Object.entries(partToModelMap)) {
                if (compatibleModels.some(model => 
                    ...
                    if (partNumber.startsWith('24B651')) {
                    ...
                    } else if (partNumber.startsWith('24B715')) {
                        fallbackProducts.push({
                            id: `${partNumber}-fallback`,
                            title: `Lexmark ${partNumber} Toner Cartridge (Compatible with ${normalizedModel})`,
                            oemNos: [{ oemNo: partNumber }],
            ...
            if (fallbackProducts.length > 0) {
                ...
                setSupplies([
                    {
                        id: "fallback1",
                        title: `Lexmark ${modelNumber} Black Toner`,
                        oemNos: [{ oemNo: "LEX-TONER-BK" }],
                        serviceLevels: [{ price: 79.99 }],
                        images: ["/static/toner-placeholder.webp"]
                    },
                    {
                        id: "fallback2",
                        title: `Lexmark ${modelNumber} Waste Toner Box`,
                        oemNos: [{ oemNo: "LEX-WB" }],
    ...
    const extractPartNumber = (product) => {
        ...
        const targetParts = ['24B6511', '24B6510', '24B6508', '24B6509', '24B6515', '24B6514', '24B6512', '24B6513', '24B7157', '24B7156', '24B7154', '24B7155'];
    ...
    const getCompatibilityInfo = (product) => {
        ...
        const compatibilityInfo = {
            '24B6511': {
                ...
                description: 'Compatible with XC6152, XC6153, XC8155'
            },
            '24B6510': {
                models: ['XC6152', 'XC6153', 'XC8155'],
                description: 'Compatible with XC6152, XC6153, XC8155'
            ...
            '24B6515': {
                ...
                description: 'Compatible with XC8160, XC8163'
            },
            '24B6514': {
                models: ['XC8160', 'XC8163'],
                description: 'Compatible with XC8160, XC8163'
            ...
            '24B7157': {
                models: ['C2240', 'XC2235'],
                description: 'Compatible with C2240, XC2235'
            },
            '24B7156': {
                models: ['C2240', 'XC2235'],
                description: 'Compatible with C2240, XC2235'
                                        ...
                                        <div key={item.id || item.oemNos[0]?.oemNo} className={styles.box}>
                                            ...
                                            {compatInfo && (
                                                <div className={styles.compatibilityBadge}>
                                                    {compatInfo.models.length > 1 ? 'Compatible with multiple models' : `For ${modelNumber}`}
                                                </div>
                                            )}
